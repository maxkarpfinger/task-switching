...
public class Level5Game : MonoBehaviour
{
    ...
    public void checkCorrectnes()
    {
        ...
        log += elapsed + "," + (trial + 1) + ",5," + Convert.ToInt32(trialIsCorrect) + "," + Convert.ToInt32(colorGame) + "," + stimulusArray[trial] + "," + (GameManager.get().getPage() + 1) + "," + Convert.ToInt32(GameManager.get().isParentMode());
