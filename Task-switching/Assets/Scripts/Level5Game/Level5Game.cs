...
public class Level5Game : MonoBehaviour
{
    ...
    public void showStars()
    {
        ...
        string number = GameObject.Find("Level5Manager").GetComponent<Level5Game>().getCorrect().ToString();
        string max = GameObject.Find("Level5Manager").GetComponent<Level5Game>().getTrials().ToString();
        ...
        {
            case 0:
                stars.GetComponent<Image>().sprite = Resources.Load<Sprite>("orange_giraffe");
                break;
            case 1:
                stars.GetComponent<Image>().sprite = Resources.Load<Sprite>("cupcake5_sticker");
                break;
            case 2:
                stars.GetComponent<Image>().sprite = Resources.Load<Sprite>("hats2_sticker");
                break;
            default:
