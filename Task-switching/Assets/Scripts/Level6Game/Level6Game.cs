...
public class Level6Game : MonoBehaviour
{
    ...
    public void checkCorrectnes()
    {
        ...
        log += elapsed + "," + (trial + 1) + ",6," + Convert.ToInt32(trialIsCorrect) + "," + Convert.ToInt32(colorGame) + "," + stimulusArray[trial] + "," + (GameManager.get().getPage()+1) + "," + Convert.ToInt32(GameManager.get().isParentMode());
    ...
    public void showStars()
    {
        ...
        {
            case 0:
                stars.GetComponent<Image>().sprite = Resources.Load<Sprite>("presents");
                break;
            case 1:
                stars.GetComponent<Image>().sprite = Resources.Load<Sprite>("cake_sticker");
                break;
            case 2:
                stars.GetComponent<Image>().sprite = Resources.Load<Sprite>("hats3_sticker");
                break;
            default:
